...
(function(){
  ...
  socket.on('update_topup', (data) => { console.log('update_topup', data); });
  socket.on('new_withdraw', (data) => { console.log('new_withdraw', data); });
  socket.on('new_work', (data) => { console.log('new_work', data); });
